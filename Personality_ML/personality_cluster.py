...
def  get_json(userjson):

def get_response(filedirectory):
    #This function gets the response of the user
    my_response = pd.read_csv(filedirectory)
    return my_response
...
def userPersonality_cluster():
    ...
    print("My Personality class is ",my_personality)
